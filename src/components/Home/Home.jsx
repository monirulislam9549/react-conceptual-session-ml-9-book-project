...
import reader from './99349-girl-with-books.json'
    ...
    return (
        <div className=' px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 flex flex-col items-center justify-between lg:flex-row'>
            ...
            <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
                <div className='max-w-xl mb-6 lg:mt-8'>
                    ...
                    <p className='text-base text-gray-700 md:text-lg'>
                        ...
                        those original thoughts of his arent very new after all. The man
                        who does not read good books is no better than the man who cant.
                    </p>
                </div>
            ...
            <div className='relative lg:w-1/2 '>
                <div className='w-full lg:w-4/5 lg:ml-auto h-48  sm:h-96'>
